...
private:
  ...
  void UpdateStateRadar(VectorXd* x_out, MatrixXd* P_out, MatrixXd& Xsig_pred, MatrixXd& Zsig,
  VectorXd& z_pred, MatrixXd& S, VectorXd& z);

  void PredictLidarMeasurement(VectorXd* z_out, MatrixXd* S_out, MatrixXd* Zsig);

  void UpdateStateLidar(VectorXd* x_out, MatrixXd* P_out, MatrixXd& Xsig_pred, MatrixXd& Zsig,
  VectorXd& z_pred, MatrixXd& S, VectorXd& z);
};
